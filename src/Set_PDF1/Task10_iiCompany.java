...
//Wtite the collection program for List of Set of Employee. With generic using iterator

public class Task10_iiCompany {
	...
	public List designation()
	{
		...
		Task10_Address ad3=new Task10_Address();
		 ...
		 public static void main(String args[])
		 {
			...
			Iterator<Set<Task10_Employee>> itr=data.iterator();
			System.out.println("   EMPLOYEE    RECORDS ");
			System.out.println("------------------------------");
			 while(itr.hasNext())
			 {
				 Set<Task10_Employee> em=itr.next();
				 Iterator<Task10_Employee> itr1=em.iterator();
				 while(itr1.hasNext())
				 {
					 Task10_Employee em1= itr1.next();
